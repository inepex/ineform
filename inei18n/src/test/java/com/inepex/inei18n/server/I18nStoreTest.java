...
public class I18nStoreTest {
    ...
    public void init() {
        ...
        /**
         * provider should be set to appropriate client or server side before
         * use
         */
    ...
    @Test
    public void createSourceFilesFromCsv()
    ...
    @Test
    public void generateModuleFileToConsole()
        throws ResourceNotFoundException,
        ParseErrorException,
        Exception {
        loadModulesFromCsv();
