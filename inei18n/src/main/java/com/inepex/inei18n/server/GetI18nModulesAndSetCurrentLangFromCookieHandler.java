...
public class GetI18nModulesAndSetCurrentLangFromCookieHandler
    ...
    @Inject
    public GetI18nModulesAndSetCurrentLangFromCookieHandler(
        I18nStore_Server serverI18nStore,
    ...
    @Override
    public GetI18nModulesAndSetCurrentLangFromCookieResult execute(
        GetI18nModulesAndSetCurrentLangFromCookieAction action,
        ...
        logger.info(
            "Requested lang: {}, after action, current lang is: {}",
            action.getRequestedLang(),
            currentLang.getCurrentLang());

        return new GetI18nModulesAndSetCurrentLangFromCookieResult(
            currentLang.getCurrentLang(),
    ...
    public void rollback(
        GetI18nModulesAndSetCurrentLangFromCookieAction arg0,
        GetI18nModulesAndSetCurrentLangFromCookieResult arg1,
