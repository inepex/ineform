...
public class GetI18nModulesAndSetCurrentLangFromCookieAction implements Action<GetI18nModulesAndSetCurrentLangFromCookieResult> {
	...
	public GetI18nModulesAndSetCurrentLangFromCookieAction(String requestedLang, Collection<String> moduleNames) {
