...
public class MeetingAssist extends Assist {
    ...
    public FormRDesc getROFormRDesc() {
        ...
        formRDesc
            ...
            .addChild(
                MeetingConsts.k_meetingTimestamp,
                new WidgetRDesc(/* hc:f2 */FWTypes.DATEBOX, "date", "hourmin"/* hc */))
    ...
    public FormRDesc getSearchFormRDesc() {
        ...
        searchFormRDesc
            ...
            .addChild(
                MeetingConsts.s_meetingTimestamp,
                new WidgetRDesc(/* hc:fs2 */FWTypes.NUMBERTEXTBOX/* hc */))
