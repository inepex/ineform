...
public class CompanySelectorPage extends ConnectorPage {
	...
	CompanySelectorPage(IneDispatch dispatcher, EventBus eventBus, DescriptorStore descriptorStore) {
		...
		ServerSideDataConnector connector = createConnector(dispatcher, eventBus, CompanyKVO.descriptorName);
		
		sortableIneTable = new SortableIneTable(descriptorStore, CompanyKVO.descriptorName, connector);
