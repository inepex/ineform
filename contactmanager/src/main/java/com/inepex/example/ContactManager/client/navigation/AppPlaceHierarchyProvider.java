...
public class AppPlaceHierarchyProvider extends DefaultPlaceHierarchyProvider {
    ...
    @Inject
    MeetingWidgetPlace meetingWidgetPlace;

    @Inject
    Provider<CompanyListPage> companyListProvider;
    @Inject
    Provider<DefaultOneParamPresenter> oneParamPresenter;
    @Inject
    Provider<NewCompanyPage> companyNewProvider;
    @Inject
    Provider<CompanyDetailsPage> companyDetials;
    @Inject
    Provider<CompanyEditPage> companyEdit;
    @Inject
    Provider<CompanyContactEditPage> companyContactEditProvider;
    @Inject
    Provider<CompanyDeletePage> companyDelete;
    @Inject
    Provider<MeetingSelectorPage> meetingSelectorPage;
    @Inject
    Provider<ContactSelectorPage> contactSelectorPage;

    @Inject
    Provider<NewMeetingPage> meetingNewProvider;
    @Inject
    Provider<MeetingDetailsPage> meetingDetailsProvider;

    @Inject
    ContactWidgetPlace contactWidgetPlace;
    @Inject
    Provider<ContactDetailsPage> contactDetailsProvider;
    @Inject
        ...
        placeRoot
            ...
            .addChild(
                ...
                usr(new SimpleCachingPlace(companyNewProvider))
                    .setMenuName(CMI18n.menu_COMPNEW())
                    .putRight())
            .getParent();
    }
