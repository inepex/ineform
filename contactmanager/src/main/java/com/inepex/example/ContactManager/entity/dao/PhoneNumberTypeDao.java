...
public class PhoneNumberTypeDao extends BaseDao<PhoneNumberType> {
	...
	public static interface PhoneNumberTypeSelectorCustomizer extends SelectorCustomizer<CriteriaSelector<?,PhoneNumberType>> {
	}
	
	@Inject
	public PhoneNumberTypeDao(Provider<EntityManager> em, ManipulationObjectFactory objectFactory){
		super(em, objectFactory);
	}

	@Override
	public BaseQuery<PhoneNumberType> getQuery() {
		return new PhoneNumberTypeQuery();
	}

	@Override
	public BaseMapper<PhoneNumberType> getMapper() {
		return new PhoneNumberTypeMapper();
	}

	@Override
	public CriteriaSelector<PhoneNumberType, PhoneNumberType> getSelector() {
		return new CriteriaSelector<PhoneNumberType, PhoneNumberType>(em, getQuery(), PhoneNumberType.class, PhoneNumberType.class);
	}

	@Override
	public CriteriaSelector<Long, PhoneNumberType> getCountSelector() {
		return new CriteriaSelector<Long, PhoneNumberType>(em, getQuery(), Long.class, PhoneNumberType.class);
	}
