...
public class PhoneNumberAssist extends Assist {
	...
	public TableRDesc getTableRDesc() {
		...
		tableRDesc.getRootNode()
			.addChild(PhoneNumberConsts.k_id, new ColRDesc(/*hc:tdr1_1*/true/*hc*/)/*hc:tdr2_1*//*hc*/)
			.addChild(PhoneNumberConsts.k_number, new ColRDesc(/*hc:tdr1_2*/true/*hc*/)/*hc:tdr2_2*//*hc*/)
			.addChild(PhoneNumberConsts.k_type, new ColRDesc(/*hc:tdr1_3*/true/*hc*/)/*hc:tdr2_3*//*hc*/)
			;
		return tableRDesc;
	}
