...
public class PhoneNumberAssist extends Assist {
	...
	public ObjectDesc getObjectDesc() {
		ObjectDesc objDesc = new ObjectDesc(PhoneNumberConsts.descriptorName
			, new LongFDesc(PhoneNumberConsts.k_id, /*hc:d1*/CMI18n.phoneNumber_id()/*hc*/)/*hc:d2_1*//*hc*/
			, new StringFDesc(PhoneNumberConsts.k_number, /*hc:d2*/CMI18n.phoneNumber_number()/*hc*/)/*hc:d2_2*//*hc*/
					.mandatory()
	...
	public TableRDesc getTableRDesc() {
		...
		tableRDesc.getRootNode()
			.addChild(PhoneNumberConsts.k_id, new ColRDesc(/*hc:tdr1_1*/100, true/*hc*/)/*hc:tdr2_1*//*hc*/)
			.addChild(PhoneNumberConsts.k_number, new ColRDesc(/*hc:tdr1_2*/100, true/*hc*/)/*hc:tdr2_2*//*hc*/)
			.addChild(PhoneNumberConsts.k_type, new ColRDesc(/*hc:tdr1_3*/100, true/*hc*/)/*hc:tdr2_3*//*hc*/)
			;
		return tableRDesc;
	}
	...
	public FormRDesc getFormRDesc() {
		FormRDesc formRDesc = new FormRDesc(PhoneNumberConsts.descriptorName/*hc:frd_props*/
	...
	public ObjectDesc getSearchObjectDesc() {			
		return new ObjectDesc(PhoneNumberConsts.searchDescriptor
	...
	public FormRDesc getSearchFormRDesc() {
		...
		searchFormRDesc.getRootNode().dummy()
			...
			.addChild(PhoneNumberConsts.s_number, new WidgetRDesc(/*hc:fs2*/FWTypes.TEXTBOX/*hc*/))
			.addChild(PhoneNumberConsts.s_type, new WidgetRDesc(/*hc:fs3*/FWTypes.LISTBOX/*hc*/))
