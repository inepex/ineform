...
public class UserAssist extends Assist {
	...
	public ObjectDesc getObjectDesc() {
		ObjectDesc objDesc = new ObjectDesc(UserConsts.descriptorName
			, new LongFDesc(UserConsts.k_id, /*hc:d1*/CMI18n.user_id()/*hc*/)/*hc:d2_1*//*hc*/
			, new StringFDesc(UserConsts.k_firstName, /*hc:d2*/CMI18n.user_firstName()/*hc*/)/*hc:d2_2*//*hc*/
					.mandatory()
			, new StringFDesc(UserConsts.k_lastName, /*hc:d3*/CMI18n.user_lastName()/*hc*/)/*hc:d2_3*//*hc*/
					.mandatory()
			, new StringFDesc(UserConsts.k_email, /*hc:d4*/CMI18n.user_email()/*hc*/)/*hc:d2_4*//*hc*/
					.mandatory()
		);
