    ...
    public static void main(String[] args) {
        ...
        Company blueEagle =
            new Company(
                ...
                list(
                    new Contact("Boss Blue", list(
                        new PhoneNumber("+22-223-5839", home),
                        new PhoneNumber("+22-545-3759", work),
                        new PhoneNumber("+22-329-9524", other)), list(new EmailAddress(
                        "boss@blueeagle.com"), new EmailAddress("charlie74@gmail.com"))),
                    new Contact(
                        "John Blue",
                        list(new PhoneNumber("+22-133-2356", home), new PhoneNumber(
                            "+23-3854-9554",
                            work), new PhoneNumber("+22-2345-4385", other)), list(new EmailAddress(
                            "john.blue@blueeagle.com"), new EmailAddress(
                            "jack.the.ripper@hotmail.com")))));
        ...
        Company redYellow =
            new Company(
                ...
                list(
                    new Contact("Ryan", list(
                        new PhoneNumber("+10-123-1123", home),
                        new PhoneNumber("+10-942-2245", work),
                        new PhoneNumber("+10-100-1943", other)), list(new EmailAddress(
                        "ryan@redyellow.com"), new EmailAddress("ryan.lapas@redyellow.com"))),
                    new Contact("Jeremy", list(new PhoneNumber("+10-123-222", home)), list(
                        new EmailAddress("jeremy@redyellow.com"),
                        new EmailAddress("jeremy85@gmail.com"))),
                    new Contact("Mr Charlie Brown", list(
                        new PhoneNumber("+10-153-2522", home),
                        new PhoneNumber("+10-323-25223", work),
                        new PhoneNumber("+10-126-2473", other)), null)));
        ...
        Company inclust =
            new Company(
                ...
                "support@inclust.com",
                "http://inclust.com/",
                list(new Contact("Mihály Csordás", null, list(new EmailAddress(
                    "mihaly.csordas@inclust.com "))), new Contact(
                    "Szabolcs Csincsi",
                    null,
                    list(new EmailAddress("szabolcs.csincsi@inclust.com"))), new Contact(
                    "Gabor Madi",
                    null,
        ...
        Company bme =
            new Company(
                ...
                "http://portal.bme.hu/",
                list(
                    new Contact("Gábor Nagy", list(
                        new PhoneNumber("+1-153-2522", home),
                        new PhoneNumber("+1-126-2473", other)), list(new EmailAddress(
                        "nagygabor@mail.bme.hu"))),
                    new Contact("Borbála Lantos", list(
                        new PhoneNumber("+1-153-2522", home),
                        new PhoneNumber("+1-323-25223", work),
                        new PhoneNumber("+1-126-2473", other)), list(new EmailAddress(
                        "borbala.lantos@mail.bme.hu"), new EmailAddress(
                        "titkarsag.ppke@mail.bme.hu")))));

        linkCompany(bme);
        em.persist(bme);

        Company friedCheeseCorp =
            new Company("Fried Cheese Meal", "+34-063-1811", "mail@sfc.hu", "http://sfc.hu/", list(
                new Contact("Gábor Nagymarosi", list(
                    new PhoneNumber("+34-153-2522", home),
                    new PhoneNumber("+34-126-2473", other)), list(new EmailAddress(
                    "nagymarosigabor@sfc.hu"))),
                new Contact("Andrea Tóth", list(
                    new PhoneNumber("+34-153-2522", home),
                    new PhoneNumber("+34-323-25223", work)), list(new EmailAddress(
                    "tothandrea@sfc.hu"))),
                new Contact("Borbála Lakatos", list(
                    new PhoneNumber("+34-153-2522", home),
                    new PhoneNumber("+34-323-25223", work),
                    new PhoneNumber("+34-126-2473", other)), list(new EmailAddress(
                    "borbala.lakatos@sfc.hu"), new EmailAddress("titkarsag@sfc.hu")))));
        ...
        Company eee =
            new Company(
                ...
                list(new Contact(
                    ...
                    list(new EmailAddress("ed@eeetoys.com"))), new Contact(
                    "Edd",
                    list(new PhoneNumber("+43-153-2524", work)),
                    list(new EmailAddress("edd@eeetoys.com"))), new Contact(
                    "Edddy",
