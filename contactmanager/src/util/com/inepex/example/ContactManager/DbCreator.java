	...
	public static void main(String[] args) {
		...
		Company blueEagle = new Company("Blue Eagle Corporation", "+22-883-2678", "info@blueeagle.com", "http://www.blueeagle.com",
				list(new Contact("Big Boss"
						...
						, list(new EmailAddress("boss@blueeagle.com"),
								new EmailAddress("charlie74@gmail.com"))),
					 new Contact("John Blue"
						, list(new PhoneNumber("+22-133-2356", home),
		...
		Company redYellow = new Company("Red-Yellow Ltd.", "+10-239-2345", "contact@redyellow.com", "http://www.red-yellow.com",
				list(new Contact("Ryan"
						, list(new PhoneNumber("+10-123-1123", home),
								new PhoneNumber("+10-942-2245", work),
								new PhoneNumber("+10-100-1943", other))
						, list(new EmailAddress("ryan@redyellow.com"),
								new EmailAddress("ryan.lapas@redyellow.com"))),
					new Contact("Jeremy"
							, list(new PhoneNumber("+10-123-222", home))
							, list(new EmailAddress("jeremy@redyellow.com"),
									new EmailAddress("jeremy85@gmail.com"))),
					new Contact("Mr Charlie Brown"
		...
		Company inclust = new Company("Inclust Systems Kft.", "+3630-638-3169", "support@inclust.com", "http://inclust.com/",
			list(new Contact("Mihály Csordás"
							, null
							, list(new EmailAddress("mihaly.csordas@inclust.com "))),
					new Contact("Szabolcs Csincsi"
							, null
		...
		Company bme = new Company("Budapest University of Technology and Economics", "+1-463-1111", "info@mail.bme.hu", "http://portal.bme.hu/",
				list(new Contact("Gábor Nagy"
								, list(new PhoneNumber("+1-153-2522", home),
										new PhoneNumber("+1-126-2473", other))
								, list(new EmailAddress("nagygabor@mail.bme.hu"))),
						new Contact("Borbála Lantos"
								, list(new PhoneNumber("+1-153-2522", home),
		...
		Company eee = new Company("Ed, Edd n Eddy Toys", "+43-142-234", "info@eeetoys.com", "http://eeetoys.com/",
				list(new Contact("Ed"
		...
		Company gRex = new Company("Generator Rex Corp.", "+1-123-2423", "generatorrex@generatorrex.com", "http://generatorrex.com/",
				list(new Contact("John"
								, list(new PhoneNumber("+1-153-2522", work))
								, null)
					,new Contact("Edward"
								, list(new PhoneNumber("+1-153-2524", work))
								, null)
					,new Contact("Roy"
