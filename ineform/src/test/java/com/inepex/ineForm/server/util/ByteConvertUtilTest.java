...
public class ByteConvertUtilTest {
    ...
    private final byte[] msg1 = new byte[] {
        36,
        36,
        66,
        49,
    ...
    private final byte[] msg2 = new byte[] {
        36,
        36,
        0,
        125,
    ...
    public void hexStringToByteArrayTest() {
        ...
        Assert.assertArrayEquals(
            new byte[] { 0x24, 0x24, 0x00 },
            ByteConvertUtil.hexStringToByteArray("24 24 00"));
    ...
    public void getHexDigitsAsByteArrayTest() {
        for (int i = 0; i <= 0xff; i++) {
            ...
            Assert.assertArrayEquals(
                "current byte=" + b,
                new byte[] { b },
                ByteConvertUtil.hexStringToByteArray(ByteConvertUtil.getHex(new byte[] { b })));

            Assert.assertArrayEquals(
                "current double byte=" + b,
                new byte[] { b, b },
                ByteConvertUtil.hexStringToByteArray(ByteConvertUtil.getHex(new byte[] { b, b })));
        }
    }
