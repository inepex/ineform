...
public class FWTypes implements Serializable, IsSerializable {
    ...
    public static final FWTypes TEXTBOXBYDOMID = new FWTypes("TEXTBOXBYDOMID");
    public static final FWTypes PASSWORDTEXTBOXBYDOMID = new FWTypes("PASSWORDTEXTBOXBYDOMID");
