...
public class ActionBasedObjectFinder implements ObjectFinder {
	...
	@Override
	public void executeFind(String descriptorName, Long id, List<String> propGroups, Callback callback) {
	...
	@Override
	public void executeFind(String descriptorName, Long id, List<String> propGroups, Callback callback, AsyncStatusIndicator customStatusIndicator) {
	...
	public void executeFind(
		...
		if (propGroups != null) action.setPropGroups(propGroups.toArray(new String[propGroups.size()]));
