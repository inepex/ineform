...
public class DefaultTableFieldRenderer implements TableFieldRenderer {
     ...
     * 
     * @see
     * com.inepex.ineForm.shared.render.TableFieldRenderer#containsCustomizer
     * (java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * com.inepex.ineForm.shared.render.TableFieldRenderer#getFieldByCustomizer
     * (java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * com.inepex.ineForm.shared.render.TableFieldRenderer#getField(java.lang
     * .String)
     */
    @Override
    ...
    private String cropText(int usingCropsLeng, int whiteSpaceCropsLeng, String text) {
        if (text.contains(" ")) {
            if (whiteSpaceCropsLeng == 0 && usingCropsLeng != 0) {
                return text.length() > usingCropsLeng
            ...
            if (usingCropsLeng != 0 || whiteSpaceCropsLeng != 0) {
                ...
                return text.length() > crop ? text.substring(0, crop) + "..." : text;
            } else {
                return text;
            }
        }
