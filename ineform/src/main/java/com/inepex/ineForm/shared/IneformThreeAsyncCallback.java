...
public abstract class IneformThreeAsyncCallback<First, Second, Third> {
    ...
    public abstract
        void
        onResponse(First firstResponse, Second secondResponse, Third thirdResponse);
}
