...
public interface ObjectFinder {
	...
	void executeFind(String descriptorName, Long id, List<String> propGroups, Callback callback, AsyncStatusIndicator customStatusIndicator);
	...
	void executeFind(String commandDescName, String objectDescName, Long id, List<String> propGroups, Callback callback, AsyncStatusIndicator customStatusIndicator);
