...
public class CachingValueRangeProvider extends DefaultValueRangeProvider {
	...
	public CachingValueRangeProvider(IneDispatch dispatch, boolean useDefaultProviderIfNotCached, String... cachedRelationDescriptorNames) {
		super(dispatch);
	...
	private void addToWaitingCalls(String descriptorName, ValueRangeResultCallback callback){
		if (waitingCalls.get(descriptorName) == null) waitingCalls.put(descriptorName, new ArrayList<ValueRangeResultCallback>());
