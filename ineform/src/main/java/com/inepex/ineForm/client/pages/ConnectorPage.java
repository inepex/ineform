 ...
 * 
 * while every page loading: -the connectors will be updated automatically
 * -waiting for UI refresh -after all displays the page content by invoking
 * onUrlParamsParsed()
 * 
...
public abstract class ConnectorPage extends HandlerAwareComposite implements InePage {
    ...
    public ServerSideDataConnector createConnector(
    ...
    @Override
    final public void setUrlParameters(
     ...
     * 
     * @param urlParams
     * @return true if parameters are correct false when should skip the
     *         updating and invonking the callback
     */
