...
/**
 * This class hold all context dependencies that is needed to create forms or
 * tables.<br/>
 * When using GIN dependencies are injected at creation time. This class should
 * not be bound in singleton context, as the {@link ValueRangeProvider} can be
 * different for different forms.
 * 
