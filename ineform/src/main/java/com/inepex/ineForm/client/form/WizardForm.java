...
public class WizardForm extends SaveCancelForm implements WizardFormView.Delegate {
    ...
    /**
     * this method uses standard Ineform resetValues and set the displayed page
     * to the first
     */
    @Override
    ...
    private WizardFormView getView() {
        if (view instanceof WizardFormView)
            return (WizardFormView) view;
        else
            throw new RuntimeException(
                "To use WizardForm you have to implement WizardFormView in your view");
    }
    ...
    public void customClick(Integer displayedPage, String label) {
        if (customClickHandler != null)
            customClickHandler.onCustomClick(displayedPage, label);
    }
