 ...
 * 
 * fields: year yearmonth date hourminsec hourmin datehourmin hourlist minlist
 * monthlist
 * 
 * other: now nowroundtosec:10 nowroundtomin:5
 * 
 * prop: s - step s(10) t - textbox m - enable select manager c - calendar
 */
public class DateTimeFW extends DenyingFormWidget implements DateTimeFieldParentInterface {
     ...
     * 
     * example: DateTimeFW field = new DateTimeFW("year:st","monthlist");
     * 
     * @param stringprops
     */
     ...
     * 
     * @param event
     *            - fire this event too, if not null
     */
    @Override
