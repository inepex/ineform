...
/**
 * use {@link IneRadioButton#createRadioButtons(String, String...)} to create
 * objects
 */
public class IneRadioButton extends HandlerAwareComposite
    ...
    private static IneRadioButtonUiBinder uiBinder = GWT.create(IneRadioButtonUiBinder.class);
