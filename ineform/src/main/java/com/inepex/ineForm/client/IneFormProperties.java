...
public class IneFormProperties {
    ...
    /**
     * IneForm uses these strings for parse and show dates in its date
     * component... A special textbox uses these strings for completing typed
     * text, correct it and manage selection on it. So if you want to change
     * these strings, be sure that:
     * 
     * -there aren't numbers in the date string -there are alphabetic characters
     * according to com.google.gwt.i18n.client.DateTimeFormat's rules, but this
     * components don't support extra strings (you can only use: y M d h H m s S
     * k K) -there can be everywhere extra non-alphabetic chars (like: -, .,
     * ...)
     * 
     * "y.M.d H:m" is ok "yyyy.MM.dd HH:mm" is ok too "y.M.d H:m 01" is not ok
     * "y.M.d H::+!,,,m" is ok, but users are going to hate you, if they must
     * every time type this char sequence into the textbox
     * 
     * 
     * On the other hand, if you use a date string, which widget never use
     * textbox, you can write into everything what is correct according to
     * com.google.gwt.i18n.client.DateTimeFormat "hh 'o''clock' a, zzzz" its ok
     * "yyyyy.MMMMM.dd GGG hh:mm aaa" ok too "yyyy.MM.dd G 'at' HH:mm:ss vvvv"
     * ok too
     * 
     */
