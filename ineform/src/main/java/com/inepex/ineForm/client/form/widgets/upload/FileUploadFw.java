...
public class FileUploadFw extends DenyingFormWidget {
	...
	private IneButton upload = new IneButton(IFButtonType.ACTION, IneFormI18n.imageuploadBtn());
	...
	private class FileUploadForm extends FlexTable {
		...
		private IneButton btnSubmit = new IneButton(IFButtonType.ACTION, IneFormI18n.imageuploadBtn());
		private IneButton btnCancel = new IneButton(IFButtonType.CANCEL, IneFormI18n.CANCEL());
	...
	private class ImageUploadPopup extends DialogBox {
		...
		public ImageUploadPopup(FileUploadFw parent, boolean withImageFinder) {
			...
			if (withImageFinder){
				imagefinder = new ImageFinderGoogle(
						parent);
		...
		public void setDefaultSearchValue(String defaultSearchValue) {
			if (withImageFinder) imagefinder.setDefaultSearchValue(defaultSearchValue);
		}
