...
public class ImageFinderGoogle extends VerticalPanel {
	...
	IneButton btn_search = new IneButton(IFButtonType.ACTION, "Search");
	...
	IneButton previous = new IneButton(IFButtonType.PAGING, IneFormI18n.PREVIOUS());
	IneButton next = new IneButton(IFButtonType.PAGING, IneFormI18n.NEXT());
