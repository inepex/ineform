...
public class ImageFinderGoogle extends VerticalPanel {
    ...
    IneButton btn_search = new IneButton(Color.GREEN, "Search");
    ...
    IneButton previous = new IneButton(Color.BLUE, IneFormI18n.PREVIOUS());
    IneButton next = new IneButton(Color.BLUE, IneFormI18n.NEXT());
    ...
    public ImageFinderGoogle(FileUploadFw parent) {
        ...
        // panel_pager.getCellFormatter().setHorizontalAlignment(0, 1,
        // HasHorizontalAlignment.ALIGN_CENTER);
        // panel_pager.getCellFormatter().setHorizontalAlignment(0, 2,
    ...
    // }
    // panel_images.add(new ImageFinderImage(result.getThumbnailUrl(),
    // result.getUrl()));
    // }
