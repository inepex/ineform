...
public class ServerIneFormI18nProvider extends ServerI18nProvider<IneFormI18n> {
    ...
    public void initTexts(IneFormI18n module) {
        ...
        module.getTextMap().put(
            "imagefinderChoosefromgoogle",
            "Choose images from Google image search");
        ...
        module.getTextMap().put(
            "validatorLT",
            "he number entered into field {fieldName} must be less then {constvalAsString}!");
        module
            .getTextMap()
            .put("validatorLength", "Maximum {maxLength} characters can be entered!");
        module.getTextMap().put(
