...
public class TranslatorAppUtilTest {
    ...
    @Test
    public void bugfix() {
        assertTrue(TranslatorAppUtil
            .isWellFormatted("<a href='http://inetrack.hu/prices?category=hosszabbitas' target='_blank'>Sms sending won't work unless you buy credits. You can buy credits at IneTrack Webshop.</a>"));
        assertTrue(TranslatorAppUtil
            .isWellFormatted("<a href='http://inetrack.hu/prices?category=hosszabbitas' target='_blank'>Az SMS értesítések használatához IneTrack SMS Crediteket kell vásárolnod az IneTrack Webshopjában.</a>"));
        assertTrue(TranslatorAppUtil
            .areParamsOfTranslatedValid(
    ...
    public void moreParams() {
        ...
        assertFalse(TranslatorAppUtil
            .areParamsOfTranslatedValid("..{p}....{r}...", "___{p}_______"));
    }
    ...
    public void multipleParam() {
        ...
        assertFalse(TranslatorAppUtil.areParamsOfTranslatedValid(
            "..{p}...{p}..{p}...",
            "___{p}__{p}____"));
        assertFalse(TranslatorAppUtil
            .areParamsOfTranslatedValid("..{p}........", "___{p}__{p}____"));
    }
    ...
    public void extraParam() {
        ...
        assertFalse(TranslatorAppUtil
            .areParamsOfTranslatedValid("..{p}........", "___{p}__{k}____"));
    }
}
