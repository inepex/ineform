...
public class LangAssist extends Assist {
    ...
    public ValidatorDesc getValidatorDesc() {
        return new ValidatorDesc(LangConsts.descriptorName, new String[] {/*
                                                                           * hc:vd1
                                                                           */
    ...
    public ObjectDesc getObjectDesc() {
        ObjectDesc objDesc =
            new ObjectDesc(
                ...
                new LongFDesc(LangConsts.k_id, /* hc:d1 */translatorappI18n.lang_id()/* hc */)/*
                                                                                               * hc
                                                                                               * :
                                                                                               * d2_1
                                                                                               *//* hc */
                ,
                new StringFDesc(LangConsts.k_isoName, /* hc:d2 */translatorappI18n.lang_isoName()/* hc */)/*
                                                                                                           * hc
                                                                                                           * :
                                                                                                           * d2_2
                                                                                                           *//* hc */
                .mandatory(),
                new StringFDesc(LangConsts.k_countryCode, /* hc:d2 */""/* hc */)/*
                                                                                 * hc
                                                                                 * :
                                                                                 * d2_2
                                                                                 *//* hc */
    ...
    public TableRDesc getTableRDesc() {
        ...
        tableRDesc
            .getRootNode()
            .addChild(LangConsts.k_id, new ColRDesc(/* hc:tdr1_1 */true/* hc */)/*
                                                                                 * hc
                                                                                 * :
                                                                                 * tdr2_1
                                                                                 *//* hc */)
            .addChild(LangConsts.k_isoName, new ColRDesc(/* hc:tdr1_2 */true/* hc */)/*
                                                                                      * hc
                                                                                      * :
                                                                                      * tdr2_2
                                                                                      *//* hc */);
    ...
    public FormRDesc getFormRDesc() {
        FormRDesc formRDesc = new FormRDesc(LangConsts.descriptorName/*
                                                                      * hc:frd_props
                                                                      */
