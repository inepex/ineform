...
public class ModuleRowAssist extends Assist {
    ...
    public ObjectDesc getObjectDesc() {
        ObjectDesc objDesc =
            new ObjectDesc(ModuleRowConsts.descriptorName, new LongFDesc(
                ModuleRowConsts.k_id,
                translatorappI18n.moduleRow_id()), new StringFDesc(
                ModuleRowConsts.k_key,
                translatorappI18n.moduleRow_key()).alphanum().mandatory(), new StringFDesc(
                ModuleRowConsts.k_description,
                translatorappI18n.moduleRow_description()).alphanumOrSpace(), new RelationFDesc(
                ModuleRowConsts.k_module,
                translatorappI18n.moduleRow_module(),
                ModuleConsts.descriptorName).mandatory(), new ListFDesc(
                ModuleRowConsts.k_values,
                translatorappI18n.moduleRow_values(),
    ...
    public TableRDesc getTableRDesc() {
        ...
        tableRDesc
            ...
            .addChild(ModuleRowConsts.k_module, new ColRDesc().cropWidth(30).setColumnWidth(80))
            .addChild(
                ModuleRowConsts.k_key,
                new ColRDesc().cropWidth(50).setColumnWidth(150).hAlign(ColRDescHAlign.LEFT))
            .addChild(
                ModuleRowConsts.k_description,
                new ColRDesc().cropWidth(200).setColumnWidth(500).hAlign(ColRDescHAlign.LEFT))
            .addChild(
                engVal,
                new ColRDesc()
                    .setColumnWidth(500)
            ...
            .addChild(
                engModTime,
                new ColRDesc().setColumnWidth(100).setDisplayName(
                    translatorappI18n.modRow_engModTime()));
        return tableRDesc;
    }
    ...
    public FormRDesc getFormRDesc() {
        ...
        formRDesc
            ...
            .addChild(
                ModuleRowConsts.k_values,
                new WidgetRDesc(FWTypes.RELATIONLIST, RelationListFW.FIXSIZED));
        return formRDesc;
    }

    @Override
    public ObjectDesc getSearchObjectDesc() {
        return new ObjectDesc(ModuleRowConsts.searchDescriptor, new LongFDesc(
            ModuleRowConsts.s_id,
            "Id"), new StringFDesc(ModuleRowConsts.s_key, "Key"), new RelationFDesc(
            ModuleRowConsts.s_module,
            "Module",
