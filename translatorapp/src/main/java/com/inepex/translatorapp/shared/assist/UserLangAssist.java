...
public class UserLangAssist extends Assist {
    ...
    public ValidatorDesc getValidatorDesc() {
        return new ValidatorDesc(UserLangConsts.descriptorName, new String[] {/*
                                                                               * hc:
                                                                               * vd1
                                                                               */
    ...
    public ObjectDesc getObjectDesc() {
        ObjectDesc objDesc =
            new ObjectDesc(UserLangConsts.descriptorName, new LongFDesc(
                UserLangConsts.k_id, /* hc:d1 */
                translatorappI18n.userLang_id()/* hc */)/* hc:d2_1 *//* hc */
            ...
            .mandatory(), new RelationFDesc(
                UserLangConsts.k_user, /* hc:d3 */
                translatorappI18n.userLang_user()/* hc */
                ,
    ...
    public TableRDesc getTableRDesc() {
        ...
        tableRDesc
            .getRootNode()
            .addChild(UserLangConsts.k_id, new ColRDesc(/* hc:tdr1_1 */true/* hc */)/*
                                                                                     * hc
                                                                                     * :
                                                                                     * tdr2_1
                                                                                     *//* hc */)
            .addChild(UserLangConsts.k_lang, new ColRDesc(/* hc:tdr1_2 */true/* hc */)/*
                                                                                       * hc
                                                                                       * :
                                                                                       * tdr2_2
                                                                                       *//* hc */)
            .addChild(UserLangConsts.k_user, new ColRDesc(/* hc:tdr1_3 */true/* hc */)/*
                                                                                       * hc
                                                                                       * :
                                                                                       * tdr2_3
                                                                                       *//* hc */);
    ...
    public FormRDesc getFormRDesc() {
        FormRDesc formRDesc = new FormRDesc(UserLangConsts.descriptorName/*
                                                                          * hc:
                                                                          * frd_props
                                                                          */
    ...
    public ObjectDesc getSearchObjectDesc() {
        return new ObjectDesc(UserLangConsts.searchDescriptor, new LongFDesc(
            UserLangConsts.s_id, /* hc:ds1 */
            "Id"/* hc */));
    }
