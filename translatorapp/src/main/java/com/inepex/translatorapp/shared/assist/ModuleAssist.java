...
public class ModuleAssist extends Assist {
    ...
    public ValidatorDesc getValidatorDesc() {
        return new ValidatorDesc(ModuleConsts.descriptorName, new String[] {/*
                                                                             * hc:
                                                                             * vd1
                                                                             */
    ...
    public ObjectDesc getObjectDesc() {
        ObjectDesc objDesc =
            new ObjectDesc(
                ...
                new LongFDesc(ModuleConsts.k_id, /* hc:d1 */translatorappI18n.module_id()/* hc */)/*
                                                                                                   * hc
                                                                                                   * :
                                                                                                   * d2_1
                                                                                                   *//* hc */
                ,
                new StringFDesc(ModuleConsts.k_name, /* hc:d2 */translatorappI18n.module_name()/* hc */)/*
                                                                                                         * hc
                                                                                                         * :
                                                                                                         * d2_2
                                                                                                         *//* hc */
                ...
                , ModuleLangConsts.descriptorName)/* hc:d2_4 *//* hc */
            );
    ...
    public TableRDesc getTableRDesc() {
        ...
        tableRDesc
            .getRootNode()
            .addChild(ModuleConsts.k_id, new ColRDesc(/* hc:tdr1_1 */true/* hc */)/*
                                                                                   * hc
                                                                                   * :
                                                                                   * tdr2_1
                                                                                   *//* hc */)
            .addChild(ModuleConsts.k_name, new ColRDesc(/* hc:tdr1_2 */true/* hc */)/*
                                                                                     * hc
                                                                                     * :
                                                                                     * tdr2_2
                                                                                     *//* hc */)
            .addChild(ModuleConsts.k_rows, new ColRDesc(/* hc:tdr1_3 *//* hc */)/*
                                                                                 * hc
                                                                                 * :
                                                                                 * tdr2_3
                                                                                 *//* hc */)
            .addChild(ModuleConsts.k_langs, new ColRDesc(/* hc:tdr1_4 *//* hc */)/*
                                                                                  * hc
                                                                                  * :
                                                                                  * tdr2_4
                                                                                  *//* hc */);
    ...
    public FormRDesc getFormRDesc() {
        FormRDesc formRDesc = new FormRDesc(ModuleConsts.descriptorName/*
                                                                        * hc:
                                                                        * frd_props
                                                                        */
    ...
    public ObjectDesc getSearchObjectDesc() {
        return new ObjectDesc(ModuleConsts.searchDescriptor, new LongFDesc(
            ModuleConsts.s_id, /* hc:ds1 */
            "Id"/* hc */), new StringFDesc(ModuleConsts.s_name, /* hc:ds2 */"Name"/* hc */));
    }
