...
public class ModuleLangAssist extends Assist {
    ...
    public ValidatorDesc getValidatorDesc() {
        return new ValidatorDesc(ModuleLangConsts.descriptorName, new String[] {/*
                                                                                 * hc
                                                                                 * :
                                                                                 * vd1
                                                                                 */
    ...
    public ObjectDesc getObjectDesc() {
        ObjectDesc objDesc =
            new ObjectDesc(ModuleLangConsts.descriptorName, new LongFDesc(
                ModuleLangConsts.k_id, /* hc:d1 */
                translatorappI18n.moduleLang_id()/* hc */)/* hc:d2_1 *//* hc */
            , new RelationFDesc(
                ModuleLangConsts.k_lang, /* hc:d2 */
                translatorappI18n.moduleLang_lang()/* hc */
                ,
                LangConsts.descriptorName)/* hc:d2_2 *//* hc */
            .mandatory(), new RelationFDesc(
                ModuleLangConsts.k_module, /* hc:d4 */
                translatorappI18n.moduleLang_module()/* hc */
                ,
    ...
    public TableRDesc getTableRDesc() {
        ...
        tableRDesc
            .getRootNode()
            .addChild(ModuleLangConsts.k_id, new ColRDesc(/* hc:tdr1_1 */true/* hc */)/*
                                                                                       * hc
                                                                                       * :
                                                                                       * tdr2_1
                                                                                       *//* hc */)
            .addChild(ModuleLangConsts.k_lang, new ColRDesc(/* hc:tdr1_2 */true/* hc */)/*
                                                                                         * hc
                                                                                         * :
                                                                                         * tdr2_2
                                                                                         *//* hc */)
            .addChild(ModuleLangConsts.k_module, new ColRDesc(/* hc:tdr1_4 */true/* hc */)/*
                                                                                           * hc
                                                                                           * :
                                                                                           * tdr2_4
                                                                                           *//* hc */);
    ...
    public FormRDesc getFormRDesc() {
        FormRDesc formRDesc = new FormRDesc(ModuleLangConsts.descriptorName/*
                                                                            * hc:
                                                                            * frd_props
                                                                            */
        ...
        formRDesc
            ...
            .addChild(
                ModuleLangConsts.k_module,
                new WidgetRDesc(/* hc:f4 */FWTypes.LISTBOX/* hc */));
        return formRDesc;
    }

    @Override
    public ObjectDesc getSearchObjectDesc() {
        return new ObjectDesc(ModuleLangConsts.searchDescriptor, new LongFDesc(
            ModuleLangConsts.s_id, /* hc:ds1 */
            "Id"/* hc */));
    }
