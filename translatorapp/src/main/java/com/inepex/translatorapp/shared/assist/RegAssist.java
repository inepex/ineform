...
public class RegAssist extends Assist {
    ...
    public ValidatorDesc getValidatorDesc() {
        return new ValidatorDesc(RegConsts.descriptorName, new String[] {/*
                                                                          * hc:vd1
                                                                          */
    ...
    public ObjectDesc getObjectDesc() {
        ObjectDesc objDesc =
            new ObjectDesc(
                RegConsts.descriptorName,
                new LongFDesc(RegConsts.k_id, /* hc:d1 */translatorappI18n.reg_id()/* hc */)/*
                                                                                             * hc
                                                                                             * :
                                                                                             * d2_1
                                                                                             *//* hc */
                ...
                new StringFDesc(RegConsts.k_email, /* hc:d2 */translatorappI18n.reg_email()/* hc */)
                    .email()
                    .mandatory()/* hc:d2_2 *//* hc */
                ,
                new StringFDesc(RegConsts.k_password, /* hc:d3 */translatorappI18n.reg_password()/* hc */)
                    .mandatory()/* hc:d2_3 *//* hc */
                ,
                new StringFDesc(RegConsts.k_passwordAgain, /* hc:d4 */translatorappI18n
                    .reg_passwordAgain()/* hc */).mandatory()/* hc:d2_4 *//* hc */
            );
    ...
    public FormRDesc getFormRDesc() {
        FormRDesc formRDesc = new FormRDesc(RegConsts.descriptorName/*
                                                                     * hc:frd_props
                                                                     */
        ...
        formRDesc
            ...
            .addChild(
                RegConsts.k_password,
                new WidgetRDesc(/* hc:f3 */FWTypes.PASSWORDTEXTBOX/* hc */))
            .addChild(
                RegConsts.k_passwordAgain,
                new WidgetRDesc(/* hc:f4 */FWTypes.PASSWORDTEXTBOX/* hc */));
        return formRDesc;
    }
