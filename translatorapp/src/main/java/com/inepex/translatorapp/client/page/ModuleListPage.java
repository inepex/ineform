...
public class ModuleListPage extends FlowPanelBasedPageWithScroll {
    ...
    ModuleListPage(
        ...
        final RowCommandDataManipulator manipulator =
            manipulatorFactory.createRowCommand(ModuleConsts.descriptorName, connector, true);
        ...
        manipulator.getUserCommands().add(new IneTable.UserCommand() {
            ...
            public boolean visible(AssistedObject kvoOfRow) {
                ...
                return list == null
                    || list.getRelationList() == null
                    || list.getRelationList().isEmpty();
            }
