...
public class UserLangDao extends BaseDao<UserLang> {
	...
	@Inject
	public UserLangDao(Provider<EntityManager> em, ManipulationObjectFactory objectFactory
	...
	public CriteriaSelector<UserLang, UserLang> getSelector() {
		return new CriteriaSelector<UserLang, UserLang>(em, getQuery(), UserLang.class, UserLang.class);
	}
