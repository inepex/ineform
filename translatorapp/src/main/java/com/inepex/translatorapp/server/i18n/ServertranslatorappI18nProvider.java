...
public class ServertranslatorappI18nProvider extends ServerI18nProvider<translatorappI18n> {
    ...
    public void initTexts(translatorappI18n module) {
        ...
        module.getTextMap().put(
            "inactiveAccount",
            "Your account is currently inactive. Please ask the administrator for roles!");
        module.getTextMap().put(
            "invalid",
            "Special parts of translated value (or original) are invalid");
        module.getTextMap().put("lang_id", "Id");
        module.getTextMap().put("lang_isoName", "Iso name");
        module.getTextMap().put("massUpload", "Mass upload");
        module.getTextMap().put(
            "massUploadAlert",
            "Error happened or module hasn't got languages. Please check it.");
        module.getTextMap().put("modRow_engModTime", "English mod. time");
        module.getTextMap().put("modRow_engVal", "English value");
        module
            .getTextMap()
            .put(
                "moduleLangDelQuestion",
                "This module contains <b>{emptyCount}</b> empty strings and <b>{translatedCount}</b> translated strings for the selected language. Do you really want remove this language?");
        ...
        module.getTextMap().put(
            "moduleListTitle",
            "<br />Module can be deleted, only after you remove all its languages.<br /><br />");
        ...
        module.getTextMap().put(
            "registeredEmail",
            "There is already an account for this e-mail address!");
        ...
        module.getTextMap().put(
            "rowUpload_notForEveryLang",
            "There aren't column for every languages in header");
        module.getTextMap().put(
            "rowUpload_notInHeader",
            "There is not '{fieladName}' in the header row.");
        ...
        module.getTextMap().put(
            ...
            "Successful registration. Your account will be activated soon.");
        ...
        module
            ...
            .put(
                "weakPassword",
                "Password should be at least 6 characters long. It should be contain both letters and digits!");
        module
            .getTextMap()
            .put(
                "welcomeText",
                "<h2>Welcome to our Translator application!</h2><br />If you have an account, just log in with the panel on right.<br /><br />If not, you should register: <b>click</b> the link below!<br /><br />");
    }
}
