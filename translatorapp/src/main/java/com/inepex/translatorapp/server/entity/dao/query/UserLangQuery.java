...
public class UserLangQuery extends BaseQuery<UserLang> {
    ...
    @Override
    public Order getOrderExpression(AbstractSearch action, CriteriaBuilder cb, Root<UserLang> from) {
        Order o;
        ...
        } else if (idList.get(0).equals(UserLangConsts.k_user)) {
            if (idList.size() == 1) {
