...
public class ModuleLangDao extends BaseDao<ModuleLang> {
	...
	@Inject
	public ModuleLangDao(Provider<EntityManager> em, ManipulationObjectFactory objectFactory
	...
	public CriteriaSelector<ModuleLang, ModuleLang> getSelector() {
		return new CriteriaSelector<ModuleLang, ModuleLang>(em, getQuery(), ModuleLang.class, ModuleLang.class);
	}
