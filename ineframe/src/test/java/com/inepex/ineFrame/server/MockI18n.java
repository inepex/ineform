...
public class MockI18n {
    ...
    public static <
        T extends I18nModule, K extends ServerI18nProvider<T>>
        T
        mock(Class<K> serverClazz) {
        try {
            Constructor<K> constructor = serverClazz.getConstructor(Provider.class);
            ServerI18nProvider<T> i18nProvider = constructor
                .newInstance(new MockCurrentLangProvider());
