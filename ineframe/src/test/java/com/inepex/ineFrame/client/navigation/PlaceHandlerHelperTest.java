...
public class PlaceHandlerHelperTest {
    ...
    public void testRemoveParam() {
        ...
        assertEquals(
            "home/devices?deviceGroups=1&chart=false&details=true/device/general",
            PlaceHandlerHelper.removeParam(orig, "deviceId"));
        assertEquals(
            "home/devices?deviceGroups=1&chart=false/device?deviceId=100000/general",
            PlaceHandlerHelper.removeParam(orig, "details"));
        assertEquals(
            "home/devices?deviceGroups=1&details=true/device?deviceId=100000/general",
            PlaceHandlerHelper.removeParam(orig, "chart"));
        assertEquals(
            "home/devices?chart=false&details=true/device?deviceId=100000/general",
            PlaceHandlerHelper.removeParam(orig, "deviceGroups"));
    }
    ...
    public void testCreateSameLevelMenuToken() {
        ...
        assertEquals(
            "newToken",
            PlaceHandlerHelper.createSameLevelMenuToken("anyToken", "newToken"));

        assertEquals("a/b", PlaceHandlerHelper.createSameLevelMenuToken("anyToken", "a", "b"));
        assertEquals(
            "newToken/newToken2",
            PlaceHandlerHelper.createSameLevelMenuToken("anyToken", "newToken", "newToken2"));

        assertEquals(
            "token/token2/newToken",
            PlaceHandlerHelper.createSameLevelMenuToken("token/token2/token3", "newToken"));
    }
    ...
    public void testAppendChild() {
        ...
        assertEquals(
            "mainToken/childToken",
            PlaceHandlerHelper.appendChild("mainToken", "childToken"));
        assertEquals(
            "mainToken?p=a/childToken",
            PlaceHandlerHelper.appendChild("mainToken?p=a", "childToken"));
        assertEquals(
            "mainToken/childToken",
            PlaceHandlerHelper.appendChild("mainToken/", "childToken"));
        assertEquals(
        ...
        assertEquals(
            "mainToken?p=a/childToken?a=34",
            PlaceHandlerHelper.appendChild("mainToken?p=a/", "childToken?a=34"));
    }
    ...
    public void testAppendParam() {
        ...
        assertEquals(
            "token?a=anyValue&p=12",
            PlaceHandlerHelper.appendParam("token?a=anyValue", "p", "12"));
        assertEquals(
            "mainToken/token?p=12",
            PlaceHandlerHelper.appendParam("mainToken/token", "p", "12"));
        assertEquals(
            "mainToken/token?a=anyValue&p=12",
            PlaceHandlerHelper.appendParam("mainToken/token?a=anyValue", "p", "12"));

        // when param is already set
        assertEquals("token?p=12", PlaceHandlerHelper.appendParam("token?p=10", "p", "12"));
        assertEquals(
            "token?p=12&a=anyValue",
            PlaceHandlerHelper.appendParam("token?p=10&a=anyValue", "p", "12"));
        assertEquals(
            "token?param=12",
            PlaceHandlerHelper.appendParam("token?param=10", "param", "12"));
        assertEquals(
            "token?param=12&a=anyValue",
            PlaceHandlerHelper.appendParam("token?param=10&a=anyValue", "param", "12"));
        assertEquals(
            "token?a=1&param=12&b=2",
            PlaceHandlerHelper.appendParam("token?a=1&param=10&b=2", "param", "12"));

        // when name of param is part of other param's name (pre-, post-, infix)
        assertEquals(
            "token?xxxparam=300&xxx=10",
            PlaceHandlerHelper.appendParam("token?xxxparam=300", "xxx", "10"));
        assertEquals(
            "token?paramxxx=300&xxx=10",
            PlaceHandlerHelper.appendParam("token?paramxxx=300", "xxx", "10"));
        assertEquals(
            "token?pxxxaram=300&xxx=10",
            PlaceHandlerHelper.appendParam("token?pxxxaram=300", "xxx", "10"));
        assertEquals(
            "token?xyx=300&y=10",
            PlaceHandlerHelper.appendParam("token?xyx=300&y=12", "y", "10"));
        assertEquals(
            "token?yx=300&y=10",
            PlaceHandlerHelper.appendParam("token?yx=300&y=12", "y", "10"));
        assertEquals(
            "token?xy=300&y=10",
            PlaceHandlerHelper.appendParam("token?xy=300&y=12", "y", "10"));
    }
    ...
    public void getPlacePartTest() {
        ...
        assertEquals(
            "token1/token2",
            PlaceHandlerHelper.getPlacePart("token1/token2?id=2&c=asd123"));

        assertEquals("token1/token2", PlaceHandlerHelper.getPlacePart("token1?id=2/token2"));
        assertEquals(
            "token1/token2",
            PlaceHandlerHelper.getPlacePart("token1?id=2&c=asd123/token2"));
        assertEquals(
            "token1/token2",
            PlaceHandlerHelper.getPlacePart("token1?id=2&c=asd123/token2?id=2&c=asd123"));
        assertEquals(
            "token1/token2/token3",
            PlaceHandlerHelper.getPlacePart("token1?id=2&c=asd123/token2?id=2&c=asd123/token3"));
    }
    ...
    public void getUrlParametersTest() {
        ...
        test(
            map("id", "2", "c", "asd123"),
            PlaceHandlerHelper.getUrlParameters("token1/token2?id=2&c=asd123"));
        test(
            map("id", "2", "c", "asd123"),
            PlaceHandlerHelper.getUrlParameters("token1?id=2&c=asd123/token2"));
        test(
            map("id", "2", "c", "asd123"),
            PlaceHandlerHelper.getUrlParameters("token1?id=2/token2?c=asd123"));
        test(
            map("id", "2", "c", "asd123"),
            PlaceHandlerHelper.getUrlParameters("token1?c=asd123/token2?id=2"));
    ...
    public void levelOfChangeTest() {
        ...
        assertEquals(
            1,
            PlaceHandlerHelper.levelOfChange(Arrays.asList("a", "b"), Arrays.asList("a")));
        assertEquals(
            1,
