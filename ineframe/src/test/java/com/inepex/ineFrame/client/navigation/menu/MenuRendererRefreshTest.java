...
public class MenuRendererRefreshTest extends MenuRendererTestBase {
    ...
    private class PlainPlaceHierarchyProv extends DefaultPlaceHierarchyProvider {
        ...
        public final InePlace _11 = new SimpleCachingPlace(new DummyPageProvider())
            .setMenuName("11");
        public final InePlace _111 = new SimpleCachingPlace(new DummyPageProvider())
            .setMenuName("111");
        public final InePlace _112 = new SimpleCachingPlace(new DummyPageProvider())
            .setMenuName("112");
