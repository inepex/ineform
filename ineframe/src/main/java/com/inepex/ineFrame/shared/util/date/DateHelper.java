...
public class DateHelper {
     ...
     *            in milliseconds
     * @param showSec
     *            if true seconds is showed, if false the value of seconds will
     *            be rounded into minutes (0&lt;=seconds&lt;30 +0min,
     *            30&lt;=seconds&lt;60 +1min)
     ...
     *            in milliseconds
     * @param showTilde
     *            if true the returned string begins with '~'
     * 
     * @return on the current language: '10 secs ago' .. '30 secs ago', '1 min
     *         ago' .. '5 mins ago', '10 mins ago'... '50 mins ago', '1 hour
     *         ago' ...
     */
    ...
    /**
     * Does the same as the {@linkplain DateHelper.approachDuration} method, but
     * the returned strings are shorter
     * 
     * @param durationInMs
     *            in milliseconds
     * @param showTilde
