...
public class IneFrameGinModule extends AbstractGinModule {
    ...
    protected void configure() {
        ...
        bind(MessagePanelWidget.class).in(Singleton.class);
        bind(MessagePanel.class).to(MessagePanelWidget.class);
    }
    ...
    public
        IneFrameGinModule
        setMenuRendererView(Class<? extends MenuRenderer.View> menuRendererView) {
        this.menuRendererView = menuRendererView;
        return this;
    }

    public IneFrameGinModule setIneFrameHeaderView(
        Class<? extends IneFrameHeader.View> ineFrameHeaderView) {
        this.ineFrameHeaderView = ineFrameHeaderView;
        return this;
    }

    public IneFrameGinModule setIneFrameNavigationDrawer(
        Class<? extends NavigationDrawer> navigationDrawer) {
