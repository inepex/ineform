 ...
 * unambiguously determines a place in the hierarchy<br/>
 * <br/>
 * 
 * {@link PlaceRequestEvent} can also be by just with setting the full token
 * (with parameters) as the hierarchical token part. {@link PlaceHandler} will
 * handle also that case correctly.
 *
 */
public class PlaceRequestEvent extends GwtEvent<PlaceRequestHandler> {
    ...
    public void setHierarchicalTokensWithParam(String hierarchicalTokensWithParam) {
        this.hierarchicalTokensWithParam = hierarchicalTokensWithParam;
    }
