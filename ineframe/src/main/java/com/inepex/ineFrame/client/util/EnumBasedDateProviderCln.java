...
/**
 * 
 * WARNING! you should initialize before using (and everytime when windows is
 * reloaded)
 * 
 * Based on {@link TimeZoneEnum}'s tzJson field or GWT's
 * {@link TimeZoneConstants}
 * 
 */
@Singleton
public class EnumBasedDateProviderCln implements DateProvider {
     ...
     * 
     * @param tzJson
     *            - one of {@link TimeZoneEnum}'s tzJson field or GWT's
     *            {@link TimeZoneConstants}
     */
