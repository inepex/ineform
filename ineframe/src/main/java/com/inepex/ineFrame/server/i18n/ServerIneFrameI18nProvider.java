...
public class ServerIneFrameI18nProvider extends ServerI18nProvider<IneFrameI18n> {
    ...
    public void initTexts(IneFrameI18n module) {
        ...
        module.getTextMap().put(
            "generalError",
            "Unexpected error occurred. Please try refreshing the page. If the error persist, contact the administrator!");
        ...
        module.getTextMap().put(
            "reconnection",
            "No network connection. We will try to reconnect in a few seconds.");
