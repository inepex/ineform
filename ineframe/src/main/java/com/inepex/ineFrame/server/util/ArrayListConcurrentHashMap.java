 ...
 *
 *         ConcurrentHashMap of a {@link List} of Items. Ensures creation of the
 *         list, and provides convenience functions.
 *
 * @param <T>
 *            Type of the Key
 * @param <K>
...
public class ArrayListConcurrentHashMap<T, K> {
    ...
    /**
     * Ensures that a list be created for the given id. The list returned by
     * this method can be a parameter of a synchronized block.
     * 
     * @param id
     * @return
     */
