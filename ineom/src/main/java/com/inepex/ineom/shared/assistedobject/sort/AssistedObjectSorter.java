...
public class AssistedObjectSorter {
    ...
    public static class StringComparator extends AbstractComparator {
        ...
        protected int compareField(AssistedObjectHandler o1, AssistedObjectHandler o2) {
            if (o1.getString(key) == null && o2.getString(key) == null)
                return 0;
            if (o1.getString(key) == null)
                return 1;
            if (o2.getString(key) == null)
                return -1;
    ...
    public static class BooleanComparator extends AbstractComparator {
        ...
        @Override
        protected int compareField(AssistedObjectHandler o1, AssistedObjectHandler o2) {
            if (o1.getBoolean(key) == null && o2.getBoolean(key) == null)
                return 0;
            if (o1.getBoolean(key) == null)
                return 1;
            if (o2.getBoolean(key) == null)
                return -1;
    ...
    public static class LongComparator extends AbstractComparator {
        ...
        @Override
        protected int compareField(AssistedObjectHandler o1, AssistedObjectHandler o2) {
            if (o1.getLong(key) == null && o2.getLong(key) == null)
                return 0;
            if (o1.getLong(key) == null)
                return 1;
            if (o2.getLong(key) == null)
                return -1;
    ...
    public static class DoubleComparator extends AbstractComparator {
        ...
        @Override
        protected int compareField(AssistedObjectHandler o1, AssistedObjectHandler o2) {
            if (o1.getDouble(key) == null && o2.getDouble(key) == null)
                return 0;
            if (o1.getDouble(key) == null)
                return 1;
            if (o2.getDouble(key) == null)
                return -1;
    ...
    public static class RelationComparator extends AbstractComparator {
        ...
        @Override
        protected int compareField(AssistedObjectHandler o1, AssistedObjectHandler o2) {
            if (o1.getRelation(key) == null && o2.getRelation(key) == null)
                return 0;
            if (o1.getRelation(key) == null)
                return 1;
            if (o2.getRelation(key) == null)
                return -1;
            return o1
                .getRelation(key)
                .getDisplayName()
                .compareTo(o2.getRelation(key).getDisplayName());
        }
