...
public abstract class DescriptorStore {
    ...
    /**
     * Helps in {@link DescriptorStore#getOdNames(Decoration)} method to define
     * string format.
     */
    ...
    /**
     * Some store implementations use {@link Map} and it's the key maker method
     * for {@link DescriptorBase} types.
     */
    ...
    public final <D extends DescriptorBase> void addDefaultTypedDesc(
        Marker marker,
        String objDescName,
        D defaultDesc) {
     ...
     * 
     * BE CAREFUL! The CustomKVOs' objectdescriptors can not be given by this
     * method
     * 
     * @param name
     *            The name of the {@link ObjectDesc}
     ...
     * 
     * @param decor
     *            returned string can be decorated pending on {@link Decoration}
     * @return the names of registered {@link ObjectDesc}s
     */
    public abstract String getOdNames(Decoration decor);

    public abstract <D extends DescriptorBase> D getNamedTypedDesc(
        String objDescName,
        String namedDescName,
        Class<D> clazz);

    public abstract <D extends DescriptorBase> void addNamedTypedDesc(
        Marker marker,
        String objDescName,
        String namedDescName,
        D namedDesc);
