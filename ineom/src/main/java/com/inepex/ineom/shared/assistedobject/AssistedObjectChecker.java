 ...
 *
 * it's not superclass of AssistedObject for avoid mistypes, but has the same
 * methods
 * 
...
public class AssistedObjectChecker {
    ...
    public String getValueAsString(String key) {
        ...
        switch (objectDescriptor.getField(key).getType()) {
            case BOOLEAN:
                o = getBoolean(key);
                return o == null ? null : ((Boolean) o ? IFConsts.TRUE : IFConsts.FALSE);
