 ...
 * {@link ClientDescriptorStore}. {@link ClientDescriptorStore} creates a new
 * {@link TypedDescriptorMap} for each {@link DescriptorBase} type, that is
 * added to the {@link DescriptorStore}
 * 
 * @author istvanszoboszlai
 *
 * @param <D>
 *            must be subclass of {@link DescriptorBase}
 */
