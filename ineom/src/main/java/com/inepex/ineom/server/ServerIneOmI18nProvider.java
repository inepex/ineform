...
public class ServerIneOmI18nProvider extends ServerI18nProvider<IneOmI18n> {
	...
	public void initTexts(IneOmI18n module){
		module.getTextMap().put("validationAlphanum", "This field should contain only numbers and characters!");
		module.getTextMap().put("validationAlphanumOrSpace", "This field should contain only numbers, characters or space!");
		...
		module.getTextMap().put("validatorLT", "The number entered into field {fieldName} must be less then {constvalAsString}!");
		module.getTextMap().put("validatorMaxLength", "Maximum {limit} characters can be entered!");
		module.getTextMap().put("validatorMinLength", "At least {limit} characters have to be entered!");
