...
public class Contact_ContactRoleDao extends KVManipulatorDaoBase {
	...
	public static class Contact_ContactRoleSelector<T> extends CriteriaSelector<T, Contact_ContactRole> {
		public Contact_ContactRoleSelector(EntityManager em, Class<T> resultClass) {
	...
	public Contact_ContactRoleDao(){
	}	
	
	public Contact_ContactRoleDao(EntityManager em){
		this.em = em;
	}	
	...
	public void remove(Long id) {
		/*hc:beforeremove*/
		/*hc*/
		em.remove(em.find(Contact_ContactRole.class, id));
		/*hc:afterremove*/
		/*hc*/
	}
	...
	public List<Contact_ContactRole> find(AbstractSearchAction action, Contact_ContactRoleSelectorCustomizer customizer, boolean useDefaultQuery) {
	...
	public Contact_ContactRole findById(Long id){
		Contact_ContactRole o = em.find(Contact_ContactRole.class, id);
		return o;
	}
	...
	public ObjectListResult search(AbstractSearchAction action, boolean useDefaultQuery, Contact_ContactRoleSelectorCustomizer customizer){
